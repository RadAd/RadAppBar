...
#undef HANDLE_MSG
#define HANDLE_MSG(message, fn)        case (message): *pResult = HANDLEX_##message((wParam), (lParam), (fn)); break

// Notification
#define HANDLE_NOT(message, prefn, fn)        case (message): (prefn)(uMsg, wParam, lParam, pResult); HANDLEX_##message((wParam), (lParam), (fn)); break

#define HANDLE_DEF(fn)                 default: (fn)(uMsg, wParam, lParam, pResult); break
...
/* void Cls::OnCreate(LPCREATESTRUCT lpCreateStruct, LRESULT* pResult) */
#define HANDLEX_WM_CREATE(wParam, lParam, fn) \
    (fn)((LPCREATESTRUCT)(lParam), pResult)
